...
import {
  ...
  const Skills = () => {
    ...
    return (
      <div id="skills" className="container mx-auto px-4 py-8 sm:py-16 sm:ml-24">
        <div className="text-center mb-8 sm:mb-16">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#2D2E32] mb-4">SKILLS</h1>
